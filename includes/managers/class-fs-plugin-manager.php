	...
	class FS_Plugin_Manager {
		...
		protected function get_all_modules( $module_type = false ) {
			...
			if ( false !== $module_type ) {
				return fs_get_entities( $option_manager->get_option( $module_type . 's', array() ), 'FS_Plugin' );
			}

			return array(
				self::OPTION_NAME_PLUGINS => fs_get_entities( $option_manager->get_option( self::OPTION_NAME_PLUGINS, array() ), 'FS_Plugin' ),
				self::OPTION_NAME_THEMES  => fs_get_entities( $option_manager->get_option( self::OPTION_NAME_THEMES, array() ), 'FS_Plugin' ),
			);
		}
