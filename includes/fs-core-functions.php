<?php
	...
	if ( ! function_exists( 'fs_get_template_path' ) ) {
		function fs_get_template_path( $path, $fs_root_dir = null ) {
			return ($fs_root_dir ? $fs_root_dir : WP_FS__DIR_TEMPLATES) . '/' . trim( $path, '/' );
		}

		function fs_include_template( $path, &$params = null, $fs_root_dir = null ) {
			$VARS = &$params;
			include( fs_get_template_path( $path, $fs_root_dir ) );
		}

		function fs_include_once_template( $path, &$params = null, $fs_root_dir = null ) {
			$VARS = &$params;
			include_once( fs_get_template_path( $path, $fs_root_dir ) );
		}

		function fs_require_template( $path, &$params = null, $fs_root_dir = null ) {
			$VARS = &$params;
			require( fs_get_template_path( $path, $fs_root_dir ) );
		}

		function fs_require_once_template( $path, &$params = null, $fs_root_dir = null ) {
			$VARS = &$params;
			require_once( fs_get_template_path( $path, $fs_root_dir ) );
		}

		function fs_get_template( $path, &$params = null, $fs_root_dir = null ) {
			ob_start();
