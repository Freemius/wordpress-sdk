<?php
	...
	$fs_text = array(
		...
		'delete-account-x-confirm'     => __( 'Deleting the account will automatically deactivate your %s plan license so you can use it on other sites. If you want to terminate the recurring payments as well, click the "Cancel" button, and first "Downgrade" your account. Are you sure you would like to continue with the deletion?',
			'freemius' ),
		'delete-account-confirm'       => __( 'Deletion is not temporary. Only delete if you no longer want to use this %s anymore. Are you sure you would like to continue with the deletion?',
			'freemius' ),
		...
		'cancel-trial-confirm'         => __( 'Cancelling the trial will immediately block access to all premium features. Are you sure?',
			'freemius' ),
		'after-downgrade-non-blocking' => __( 'You can still enjoy all %s features but you will not have access to %s updates and support.',
			'freemius' ),
		'after-downgrade-blocking'     => __( 'Once your license expires you can still use the Free version but you will NOT have access to the %s features.',
			'freemius' ),
		...
		'deactivation-share-reason'                => __( 'If you have a moment, please let us know why you are %s',
			'freemius' ),
		...
		'reason-temporary-deactivation'            => __( "It's a temporary deactivation. I'm just debugging an issue.",
			'freemius' ),
		'reason-temporary-x'                       => __( "It's a temporary %s. I'm just debugging an issue.",
			'freemius' ),
		'reason-other'                             => _x( 'Other',
			'the text of the "other" reason for deactivating the module that is shown in the modal box.', 'freemius' ),
		...
		'reason-great-but-need-specific-feature'   => __( "The %s is great, but I need specific feature that you don't support",
			'freemius' ),
		...
		'thanks-for-purchasing'                    => __( 'Thanks for purchasing %s! To get started, please enter your license key:',
			'freemius' ),
		'license-sync-disclaimer'                  => __( 'The %s will be periodically sending data to %s to check for %s updates and verify the validity of your license.',
			'freemius' ),
		...
		'user-exist-message'                       => __( 'Sorry, we could not complete the email update. Another user with the same email is already registered.',
			'freemius' ),
		'user-exist-message_ownership'             => __( 'If you would like to give up the ownership of the %s\'s account to %s click the Change Ownership button.',
			'freemius' ),
		...
		'premium-activated-message'                => __( 'Premium %s version was successfully activated.',
			'freemius' ),
		...
		'license-expired-blocking-message'         => __( 'Your license has expired. You can still continue using the free %s forever.',
			'freemius' ),
		...
		'in-trial-mode'                            => __( 'You are already running the %s in a trial mode.',
			'freemius' ),
		...
		'no-trials'                                => __( 'None of the %s\'s plans supports a trial period.',
			'freemius' ),
		'unexpected-api-error'                     => __( 'Unexpected API error. Please contact the %s\'s author with the following error.',
			'freemius' ),
		...
		'squid-sysadmin-desc'                      => __( 'Great, please whitelist the following domains: %s. Once you are done, deactivate the %s and activate it again.',
			'freemius' ),
		...
		'start-trial-prompt-message'               => __( 'For compliance with the WordPress.org guidelines, before we start the trial we ask that you opt-in with your user and non-sensitive site information, allowing the %s to periodically send data to %s to check for version updates and to validate your trial.', 'freemius' ),
