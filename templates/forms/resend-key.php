...
HTML;
	...
	$message_above_input_field = fs_esc_html_inline( "Enter the email address you've used " . $fs->is_only_premium() ? 'during the purchase' : 'for the upgrade below' . ' and we will resend you the license key.', 'ask-for-upgrade-email-address', $slug );
