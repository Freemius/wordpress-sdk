                            ...
                            <div id="application_form_container" <?php echo ( $is_pending_affiliate ) ? '' : 'style="display: none"' ?>>
                                ...
                                <form>
                                    ...
                                    <div>
                                        ...
                                        <label for="legal_consent_checkbox">I agree to the <a href="<?php echo $affiliate_program_terms_url ?>" target="_blank" rel="noopener">Referrer Program's</a> terms & conditions.</label>
                                    </div>
                                </form>
                            </div>
                            <?php if ( ! $is_affiliate ) : ?>
