	...
	<div id="fs_payments">
		...
		<div class="inside">
			<table class="widefat">
				<thead>
				<tr>
					<th><?php fs_echo_inline( 'id', $slug ) ?></th>
					<th><?php fs_echo_inline( 'date', $slug ) ?></th>
					<th><?php fs_echo_inline( 'amount', $slug ) ?></th>
					<th><?php fs_echo_inline( 'invoice', $slug ) ?></th>
				</tr>
				</thead>
				<tbody>
				<?php $odd = true ?>
				<?php foreach ( $payments as $payment ) : ?>
					<tr<?php echo $odd ? ' class="alternate"' : '' ?>>
						...
						<td><a href="<?php echo $fs->_get_invoice_api_url( $payment->id ) ?>"
						       ...
						       target="_blank"><?php fs_echo_inline( 'invoice', $slug ) ?></a></td>
					</tr>
