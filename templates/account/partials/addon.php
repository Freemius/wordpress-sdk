...
//            }
            ...
            if ( $fs->is_addon_installed( $addon_id ) ) {
                ...
                if ( $fs->is_allowed_to_install() ) {
                    ...
                    $buttons[] = sprintf(
                        '<a target="_blank" rel="noopener noreferrer" class="button button-primary edit" href="%s">%s</a>',
    ...
    <?php else : ?>
        ...
        <td colspan="<?php echo ( $is_addon_installed_by_filesystem || $show_delete_install_button ) ? '5' : '4' ?>">
            ...
            <?php else : ?>
                ...
                <?php else : ?>
                    <a target="_blank" rel="noopener noreferrer" class="button button-primary"
