...
<?php foreach ( $module_types as $module_type ) : ?>
    <?php $modules = fs_get_entities( $fs_options->get_option( $module_type . 's' ), 'FS_Plugin' ) ?>
                        ...
                        <td><?php
                                ...
                                if ( FS_Plugin_Plan::is_valid_id( $site->plan_id ) ) {
                                    if ( false === $all_plans ) {
                                        ...
                                        $all_plans = fs_get_entities( $fs_options->get_option( $option_name, array() ), 'FS_Plugin_Plan' );
                                    }
